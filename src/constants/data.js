...
export const projects = [
	{
		id: 1,
		projectTitle: "FlowLovedSome Money Management",
		snapshots: [
			{
				source: "/assets/project1/1.png",
				alt: "Dashboard",
			},
			{
				source: "/assets/project1/2.png",
				alt: "Transaction",
			},
			{
				source: "/assets/project1/3.png",
				alt: "Add New Transaction Modal",
			},
			{
				source: "/assets/project1/4.png",
				alt: "Mutation",
			},
		],
		tech: ["React", "NextJS", "TailwindCSS", "Firebase"],
		description:
	...
	{
		id: 2,
		projectTitle: "Le Sadie Bakery (Static Web)",
		snapshots: [
			{
				source: "/assets/project2/1.png",
				alt: "Homepage",
			},
			{
				source: "/assets/project2/2.png",
				alt: "Best Seller",
			},
			{
				source: "/assets/project2/3.png",
				alt: "Catalogue",
			},
			{
				source: "/assets/project2/4.png",
				alt: "Review",
			},
		],
	...
	},
	{
		...
		snapshots: [
			{
				source: "/assets/project3/1.png",
				alt: "To Do List",
			},
			{
				source: "/assets/project3/2.png",
				alt: "Add Group",
			},
		],
...
export const experience = [
	{
		...
		snapshots: "/assets/exp1/logo_ypt.png",
		alt: "Logo YPT",
	},
	{
		id: 2,
		experienceTitle: "Rastek ID",
		duration: "December 2024 - February 2024",
		expDescription:
			"As front-end, I assigned to my team to build the User Interface for an HR Website to monitoring employee's presence, assigning new employees, payroll, request and approving leaves, and handling client's project and task. The technology I used as front-end developer is ReactJS, and Bootstrap.",
		expTech: ["ReactJS", "Bootstrap"],
		snapshots: "/assets/exp1/logo_rastek.png",
		alt: "Logo Rastek",
	},
];
