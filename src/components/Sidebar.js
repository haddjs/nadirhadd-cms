...
const Sidebar = () => {
	return (
		<div className="bg-[#222831] min-w-1/7 min-h-screen sticky top-0 h-fit flex flex-col justify-between py-10 px-5 gap-4">
			<div className="flex flex-col gap-20">
				...
				<div className="flex flex-col px-4 md:px-0 lg:text-xl md:text-md gap-5">
					{navLinks.map((data, index) => (
						<div
							key={index}
							className="text-white cursor-pointer font-poppins lg:p-5 md:p-3 rounded-xl hover:bg-[#171b22] lg:hover:ps-6 transition-all ease-in-out duration-150">
